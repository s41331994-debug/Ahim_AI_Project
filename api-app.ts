...
function getGeminiClient() {
  ...
  if (!apiKey) {
    throw new Error("Kunci API Gemini (GEMINI_API_KEY) belum dikonfigurasi. Silakan tambahkan di Secrets atau Vercel Environment Variables.");
  }
  if (!aiClient) {
...
router.post("/gemini/generate", async (req, res) => {
  try {
    ...
    const baseSystemInstruction = 
      ...
      "Kamu dirancang khusus untuk menjadi solusi serba bisa dalam penulisan dan pembuatan produk berbasis teks, dengan focus utama pada sektor pendidikan dan kebutuhan umum/teknis.\n" +
